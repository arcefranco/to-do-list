...
function Home() {
  ...
  const { user, todos, title } = useSelector((state: RootState) => state.user);
  ...
  const onSubmitTitle = (e: React.FormEvent) => {
    e.preventDefault();
    const body = {
      id: user ? user : "",
      payload: input,
  ...
  const handelModalSubmit = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    dispatch(reset());
    setModalClose(false);
  };
            ...
            <div className={styles.itemBox}>
              <div style={{ display: "flex", placeContent: "space-between" }}>
                ...
                <div style={{ marginTop: "20px" }}>
                  ...
                  >
                    ...
                    <option value="uncompleted" disabled={uncompleted}>
                      UNCOMPLETED
                    </option>
                  </select>
                </div>
              ...
              {todos.map((e) => (
                <div key={e.todoId} className={styles.containerTodo}>
                  ...
                  <button
                    onClick={(event) =>
                      onDelete(event, e.todoId ? e.todoId : "")
                    }
                  >
                    Delete
                  </button>
      ...
      {modalClose === true && (
        <Modal>
          <div className={styles.modalTitle}>
            ...
            <p>
              Cuando empezas una nueva lista, tu lista existente se elimina{" "}
              <br />
              <br />
